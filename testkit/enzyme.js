...
export const buttonTestkitFactory = enzymeTestkitFactoryCreator(load('../src/Backoffice/Button/Button.driver'));
...
export const colorPickerTestkitFactory = enzymeTestkitFactoryCreator(load('../src/ColorPicker/color-picker.driver'));
